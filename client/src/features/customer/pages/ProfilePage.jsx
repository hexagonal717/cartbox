...
import {getCustomerInfoByParams, putCustomerInfoByParams} from "../../../api/customer/customerApi.js";
...
const ProfilePage = () => {
    ...
    async function handleSave(event) {
        try {
            event.preventDefault()
            const updatedUserInfo = await putCustomerInfoByParams(token.customerId, customerInfo);
            setIsDisabled(true);
            await refetch();

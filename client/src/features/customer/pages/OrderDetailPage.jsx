...
const OrderDetailPage = () => {
  ...
  return (
    <div className="flex min-h-screen justify-center">
      <div
        className="grid w-screen grid-cols-1 grid-rows-1 gap-3 px-4 pt-20 sm:w-96 md:w-96 md:grid-cols-1
          md:grid-rows-1 md:gap-6 lg:w-1/3 lg:gap-12">
        <div>
          <div key={order._id} className="py-2">
            <div className="mb-4 flex flex-col rounded-lg bg-neutral-950 p-6 text-neutral-200">
              ...
              <div className="mt-2 flex items-center justify-between">
                ...
                <div className="text-sm font-medium first-letter:capitalize">
                  {order?.status}
                </div>
              </div>
              <div className="mt-4">
